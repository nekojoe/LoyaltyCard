...
G.FUNCS.draw_from_exploit = function(e)
    ...
    for k, v in ipairs(G.exploit.cards) do
        if v.shredded then
            G.GAME.loyalty_card.shredded[G.GAME.loyalty_card.shredded+1] = v.ability.name
            card:dissolve()
        elseif v.burnt then
...
G.FUNCS.loyalty_save_config = function(e)
    LoyaltyCard.FUNCS.save_config()
end
  
LoyaltyCard.FUNCS.create_toggle = function(args)
    args = args or {}
...
LoyaltyCard.FUNCS.create_buttons = function(args, back, save_func)
    save_func = save_func or 'loyalty_save_config'
    args = args or {
        label = 'Label',
        toggle_ref = nil,
        ref_value = nil,
                    ...
                    nodes = {
                        ...
                        },
                        {
                            ...
                            nodes = {
                                ...
                                or nil,
                                v.toggle_ref and 
                                LoyaltyCard.FUNCS.create_toggle({
                                    scale = 0.9,
