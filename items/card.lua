...
function Card:set_sticker(sticker, bool)
    ...
    elseif sticker == 'perishable' then
        self:set_perishable(bool)
    elseif sticker == 'rental' then
        self:set_rental(bool)
    elseif sticker == 'loyalty_defective' then
        self:set_defective(bool)
    elseif sticker == 'loyalty_temporary' then
        self:set_temporary(bool)
    end
    if not sticker then
        self:set_eternal(false)
        self:set_perishable(false)
...
function Card:set_defective(bool)
    self.ability.loyalty_defective = bool or nil
end
...
function Card:set_sprites(_center, _front)
    ...
    if _center and _center.soul_pos and _center.soul_pos.extra and not LoyaltyCard.COMPAT.crytpid then
